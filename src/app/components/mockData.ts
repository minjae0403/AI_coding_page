...
export const stores: Store[] = [
  ...
  },
  {
    ...
    type: "cafe",
    category: "로컬 카페",
    address: "서울 중랑구 신내로1길 9 1층",
    district: "중랑구",
    phone: "0507-1309-8472",
    hours: "월-일 10:00-22:00",
    image: "https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=800&h=500&fit=crop&auto=format",
    description: "에그타르트와 휘낭시에 등 디저트가 맛있는 조용한 로컬 카페입니다.",
    lat: 37.6022,
    lng: 127.0935,
    congestion: 30,
    congestionUpdated: "10분 전",
    tags: ["로스터리", "디저트", "에그타르트", "조용함"],
    menu: [
      {
        id: "m9",
        name: "아메리카노",
        category: "커피",
        price: 4000,
        description: "고소한 풍미의 원두로 내린 기본 아메리카노",
        image: "https://images.unsplash.com/photo-1542181998-927503719001?w=600&h=400&fit=crop&auto=format",
        avgFlavor: { acidity: 30, sweetness: 40, bitterness: 70, body: 60, aroma: 70 },
        tags: ["#커피"],
        reviews: [],
      },
      {
        ...
        category: "디저트",
        price: 3500,
        description: "겉은 바삭하고 속은 촉촉한 매장 대표 디저트",
        image: "https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=600&h=400&fit=crop&auto=format",
        avgFlavor: { acidity: 10, sweetness: 80, bitterness: 10, body: 70, aroma: 85 },
        reviews: [],
      },
    ],
  },
